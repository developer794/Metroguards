...
function createClientConfirmationEmail(
  ...
  const industriesList = industries.length 
    ? industries.map(i => `<span style="display: inline-block; background: rgba(253, 197, 26, 0.1); color: #1e2247; padding: 4px 10px; border-radius: 4px; margin: 2px; font-size: 13px; font-weight: 500;">${i}</span>`).join("") 
    : '<span style="color: #9ca3af; font-style: italic; font-size: 13px;">Not specified</span>';

  const servicesList = services.length 
    ? services.map(s => `<span style="display: inline-block; background: rgba(253, 197, 26, 0.1); color: #1e2247; padding: 4px 10px; border-radius: 4px; margin: 2px; font-size: 13px; font-weight: 500;">${s}</span>`).join("") 
    : '<span style="color: #9ca3af; font-style: italic; font-size: 13px;">Not specified</span>';
              ...
              <tr>
                <td style="padding: 45px 50px;">
                  ...
                  <p style="color: #374151; margin: 0 0 20px 0; font-size: 15px; line-height: 1.8; font-family: 'Lato', Arial, sans-serif;">
                    Thank you for contacting Metropolitan Guard Services. We are pleased to confirm that we have received your security quote request. Your inquiry is important to us, and our team of professional security consultants is currently reviewing your requirements in detail.
                  </p>

                  <p style="color: #374151; margin: 0 0 30px 0; font-size: 15px; line-height: 1.8; font-family: 'Lato', Arial, sans-serif;">
                    A dedicated security consultant will contact you within 24 hours to discuss your specific needs and provide you with a comprehensive, tailored security solution.
                  </p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px; border: 2px solid #1e2247;">
                    ...
                    <tr>
                      ...
                      <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                        <p style="margin: 0; color: #374151; font-size: 14px; font-family: 'Lato', Arial, sans-serif;">${firstName}</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                        <p style="margin: 0; color: #374151; font-size: 14px; font-family: 'Lato', Arial, sans-serif; word-break: break-all;">${email}</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                        <p style="margin: 0; color: #374151; font-size: 14px; font-family: 'Lato', Arial, sans-serif;">${phone || "Not provided"}</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="background: #f9fafb; padding: 15px 20px; border-right: 1px solid #e5e7eb; border-bottom: 1px solid #e5e7eb;">
                        <strong style="color: #1e2247; font-size: 13px; font-weight: 700; font-family: 'Lato', Arial, sans-serif;">Service Location:</strong>
                      </td>
                      <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                        <p style="margin: 0; color: #374151; font-size: 14px; font-family: 'Lato', Arial, sans-serif;">${location}</p>
                      </td>
                    </tr>
                    ` : ''}
                    ...
                    <tr>
                      <td style="background: #f9fafb; padding: 15px 20px; border-right: 1px solid #e5e7eb; border-bottom: 1px solid #e5e7eb;">
                        <strong style="color: #1e2247; font-size: 13px; font-weight: 700; font-family: 'Lato', Arial, sans-serif;">Industry:</strong>
                      </td>
                      <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                    ...
                    <tr>
                      <td style="background: #f9fafb; padding: 15px 20px; border-right: 1px solid #e5e7eb; ${message ? 'border-bottom: 1px solid #e5e7eb;' : ''}">
                        <strong style="color: #1e2247; font-size: 13px; font-weight: 700; font-family: 'Lato', Arial, sans-serif;">Services Required:</strong>
                      </td>
                      <td style="padding: 15px 20px; ${message ? 'border-bottom: 1px solid #e5e7eb;' : ''}">
                        <div style="line-height: 2;">
                          ${servicesList}
                        </div>
                      </td>
                    ...
                    <tr>
                      <td style="background: #f9fafb; padding: 15px 20px; border-right: 1px solid #e5e7eb; vertical-align: top;">
                        <strong style="color: #1e2247; font-size: 13px; font-weight: 700; font-family: 'Lato', Arial, sans-serif;">Additional Notes:</strong>
                      </td>
                      <td style="padding: 15px 20px;">
                        <p style="margin: 0; color: #4b5563; font-size: 14px; line-height: 1.7; font-family: 'Lato', Arial, sans-serif; font-style: italic;">
                          "${message.replace(/\n/g, "<br/>")}"
                        </p>
                      </td>
                    </tr>
                  ...
                  <!-- Next Steps Section -->
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px; background: #fafafa; border: 2px solid #1e2247;">
                    <tr>
                      <td style="background: #1e2247; padding: 12px 20px; border-bottom: 3px solid #fdc51a;">
                        <h3 style="color: #fdc51a; margin: 0; font-size: 16px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; font-family: 'Merriweather', Georgia, serif;">
                          Next Steps
                        </h3>
                      </td>
                    </tr>
                      ...
                      <td style="padding: 25px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td style="padding: 10px 0 10px 10px;">
                              <p style="margin: 0; color: #374151; font-size: 14px; line-height: 1.7; font-family: 'Lato', Arial, sans-serif;">
                                Our security consultant will review your requirements in detail
                              </p>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td style="padding: 10px 0 10px 10px;">
                              <p style="margin: 0; color: #374151; font-size: 14px; line-height: 1.7; font-family: 'Lato', Arial, sans-serif;">
                                You will receive a comprehensive, tailored security solution proposal
                              </p>
                            </td>
                          </tr>
                        </table>
...
export async function POST(req: Request) {
  try {
    ...
    const servicesDisplay = services.length ? services.map(s => `<span style="display: inline-block; background: rgba(253, 197, 26, 0.1); color: #1e2247; padding: 4px 10px; border-radius: 4px; margin: 2px; font-size: 13px;">${s}</span>`).join("") : '<span style="color: #9ca3af;">Not specified</span>';
    const industriesDisplay = industries.length ? industries.map(i => `<span style="display: inline-block; background: rgba(253, 197, 26, 0.1); color: #1e2247; padding: 4px 10px; border-radius: 4px; margin: 2px; font-size: 13px;">${i}</span>`).join("") : '<span style="color: #9ca3af;">Not specified</span>';
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center">
                          ...
                          <p style="color: #1e2247; margin: 0; font-size: 14px; font-weight: 700; letter-spacing: 1px;">
                            QUOTATION #${quotation.id} • ${new Date().toLocaleDateString('en-AU', { day: 'numeric', month: 'short', year: 'numeric' }).toUpperCase()}
                          </p>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding: 45px 50px;">
                      ...
                      <tr>
                        <td style="padding: 20px 25px;">
                          <p style="color: #1e2247; margin: 0; font-size: 15px; font-weight: 600; font-family: 'Lato', Arial, sans-serif;">
                            ⚡ A new quotation request has been submitted through the website and requires your attention.
                          </p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px; border: 2px solid #1e2247;">
                      ...
                      <tr>
                        ...
                        <td style="background: #ffffff; padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                          <span style="color: #374151; font-size: 14px; font-weight: 600; font-family: 'Lato', Arial, sans-serif;">${firstName}</span>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="background: #ffffff; padding: 15px 20px; ${message ? 'border-bottom: 1px solid #e5e7eb;' : ''}">
                          <div style="line-height: 2;">
                            ${servicesDisplay}
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td style="background: #ffffff; padding: 15px 20px;">
                          <span style="color: #374151; font-size: 14px; line-height: 1.7; font-family: 'Lato', Arial, sans-serif;">${message.replace(/\n/g, '<br/>')}</span>
                        </td>
                      </tr>
                      ` : ''}
                    </table>
                    ...
                    <p style="color: #6b7280; margin: 0; font-size: 13px; line-height: 1.7; text-align: center; font-family: 'Lato', Arial, sans-serif; font-style: italic;">
                      Note: The customer has received an automated confirmation email acknowledging receipt of their quote request.
                    </p>
    ...
    // EMAIL 1: Send elegant notification to Admin
    await resend.emails.send({
      from: `Metro Guards <${process.env.CONTACT_FROM_EMAIL}>`,
      to: `${process.env.CONTACT_TO_EMAIL}`,
      replyTo: email,
      subject: `New Quote Request #${quotation.id} from ${firstName}`,
      html: adminEmailHtml,
    });
    ...
    await resend.emails.send({
      from: `Metro Guards <${process.env.CONTACT_FROM_EMAIL}>`,
      to: email,
      subject: "Quote Request Confirmation - Metropolitan Guard Services",
