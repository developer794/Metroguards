...
export default function CrowdCrontrolServicesPage() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="CROWD CONTROLLER SECURITY SERVICES"
                mainTitle="CROWD CONTROLLER SECURITY SERVICES IN MELBOURNE"
                backgroundImage="https://dqaghuhkouihcvqvcsco.supabase.co/storage/v1/object/public/MetroGuards-Images/Crowd%20Controller%20Services/660438D5-A405-4A12-A141-34F598A00D3E_1_105_c%20(1).webp"
                        ...
                        <div className="container" style={{position: 'relative', zIndex: 2}}>
                             ...
                             <div style={{marginBottom: '80px'}}>
                                        ...
                                        <h2 style={{
                                            ...
                                            <span style={{color: '#fdc51a'}}>Services</span></h2>
                                        <div className="row g-3 justify-content-center">
                                            {[
                                                { name: 'Party Security Guards', link: '/party-security-guards' },
                                                { name: 'Event Security Guards', link: '/event-security-guards' },
                                                { name: 'Corporate Event Security', link: '/corporate-event-security-guards' }
                                            ].map((service, index) => (
                                    ...
                                    <div style={{textAlign: 'center', marginBottom: '60px'}}>
                                        <div style={{
                                            ...
                                            <span style={{
                                                ...
                                                Managing Crowds With Confidence
                                            </span>
                                        </div>
                                        <h2 style={{
                                            color: '#1e2247',
                                            ...
                                            The Discipline Behind Every{' '}
                                            <span style={{color: '#fdc51a'}}>Safe Gathering</span>
                                        </h2>
                                        <div style={{
                                            width: '120px',
                                            height: '4px',
                                        ...
                                        <div className="col-lg-6">
                                            <div style={{
                                                ...
                                                <h3 style={{
                                                    ...
                                                    Trusted Presence at Every Event
                                                </h3>
                                                <p style={{
                                                    color: '#495057',
                                                    fontSize: '1.05rem',
                                                    ...
                                                    Every event carries reputation, anticipation, and care. Guests arrive to enjoy, staff strive to deliver, and organisers trust that everything will unfold as planned. Metro Guards stands beside them with Crowd Controller Guard Services designed to hold that trust steady.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6 order-lg-1 order-2">
                                            <div style={{
                                                ...
                                                <h3 style={{
                                                    ...
                                                    Calm, Reassurance, and Confidence
                                                </h3>
                                                <p style={{
                                                    color: '#495057',
                                                    fontSize: '1.05rem',
                                                    ...
                                                    Our licensed officers manage more than movement. They provide calm where pressure builds, reassurance where uncertainty appears, and confidence that every guest is safe within your space. Each team operates under a detailed event plan built around crowd size, entry control, and venue structure, ensuring compliance and composure at all times.
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{textAlign: 'center', position: 'relative', zIndex: 1}}>
                                                    ...
                                                    <p style={{
                                                        ...
                                                        Ensuring compliance and composure
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6">
                                            <div style={{
                                                ...
                                                <p style={{
                                                    ...
                                                    From private celebrations to large public gatherings, our presence is deliberate yet unobtrusive, guiding flow, easing tension, and protecting the experience for everyone involved. Metro Guards brings order with empathy, discipline with discretion, and safety that lets every moment unfold without disruption or fear.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{position: 'relative', zIndex: 1}}>
                                                    ...
                                                    <h3 style={{
                                                        ...
                                                        <span style={{color: '#fdc51a'}}>Professional Crowd Control</span>
                                                    </h3>
                                                    <p style={{
                                                        ...
                                                        Whether it's a private celebration, corporate event, or large public gathering, Metro Guards ensures your event runs smoothly with trained crowd controllers who bring discipline, discretion, and genuine care to every moment.
                                                    </p>
                                                    <a 
                                                        href="/get-quotation"
                                                        style={{
