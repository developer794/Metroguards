...
export default function MobilePatrolServicesPage() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="MOBILE SECURITY SERVICES"
                mainTitle="MOBILE SECURITY SERVICES IN MELBOURNE"
                backgroundImage="https://dqaghuhkouihcvqvcsco.supabase.co/storage/v1/object/public/MetroGuards-Images/Mobile%20Patrol%20Security/0C19E4EB-7066-445A-B768-63EA66062EAA_1_105_c%20(1).webp"
                        ...
                        <div className="container" style={{position: 'relative', zIndex: 2}}>
                            ...
                            <div style={{marginBottom: '80px'}}>
                                        ...
                                        <div className="row g-3">
                                            {[
                                                { name: 'Lock-Up Security', link: '/lock-up-security-services' },
                                                { name: 'Security Escort', link: '/security-escort-services' },
                                                { name: 'Alarm Response', link: '/alarm-response-security-guards' },
                                                { name: 'Mobile Patrols', link: '/mobile-patrol-security' },
                                                { name: 'Construction Patrol', link: '/construction-patrol-security-guards' }
                                            ].map((service, index) => (
                                ...
                                <div className="col-lg-10">
                                    ...
                                    <div style={{textAlign: 'center', marginBottom: '60px'}}>
                                        ...
                                        <h2 style={{
                                            ...
                                            Protection In{' '}
                                            <span style={{color: '#fdc51a'}}>Motion</span>
                                        </h2>
                                        <div style={{
                                            width: '120px',
                                            height: '4px',
                                        ...
                                        <div className="col-lg-6">
                                            <div style={{
                                                ...
                                                <h3 style={{
                                                    ...
                                                    Structured Protection Across Melbourne
                                                </h3>
                                                <p style={{
                                                    color: '#495057',
                                                    fontSize: '1.05rem',
                                                    ...
                                                    When operations extend beyond one site, when assets, vehicles, or teams are on the move, risk travels with them. Metro Guards' Mobile Security Services provide structured protection for everything in motion, after hours, between locations, and across Melbourne's working landscape.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6 order-lg-1 order-2">
                                            <div style={{
                                                ...
                                                <p style={{
                                                    ...
                                                    Our mobile teams operate across Melbourne and regional Victoria with precision, vigilance, and care. From nightly lock-ups and alarm responses to construction patrols and security escorts, every movement is overseen through GPS tracking, supervisor validation, and live reporting. Nothing is left to chance. Every inspection, every route, and every site are handled as if it were our own.
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{textAlign: 'center', position: 'relative', zIndex: 1}}>
                                                    ...
                                                    <p style={{
                                                        ...
                                                        Trained for coordination & emergency response
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6">
                                            <div style={{
                                                ...
                                                <p style={{
                                                    ...
                                                    Clients trust Metro Guards for mobile protection that adapts to change, from warehouses and logistics hubs to business parks and construction corridors. Each patrol is led by licensed officers trained in coordination, emergency response, and calm under pressure.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{position: 'relative', zIndex: 1}}>
                                                    ...
                                                    <h3 style={{
                                                        ...
                                                        Safety That{' '}
                                                        <span style={{color: '#fdc51a'}}>Never Stops Moving</span>
                                                    </h3>
                                                    <p style={{
                                                        ...
                                                        Mobile security is an act of responsibility, a promise that safety continues even after everyone else has gone home. Metro Guards carries that promise with consistency and heart, delivering movement-based protection built on human care, field expertise, and an unbroken commitment to the safety of every site we guard.
                                                    </p>
                                                    <a 
                                                        href="/get-quotation"
                                                        style={{
