...
const valuesData = [
  {
    ...
    title: "Integrity",
    description: "We act with honesty, transparency, and accountability at all times. Our clients trust us with their people and property, and we earn that trust through consistent, ethical conduct.",
    color: "#1e2247"
  },
  {
    id: 2,
    ...
    description: "From communication to on-site conduct, our professional security guards in Melbourne maintain the highest standards. Trained, licensed, and well-presented",
    color: "#2d3748"
  },
  {
    id: 3,
    ...
    title: "Safety First",
    description: "Protecting people and property is our top priority. Following strict safety protocols, we proactively manage risks across Melbourne CBD security services, warehouses, and construction sites.",
    color: "#4a5568"
  },
  {
    id: 4,
    ...
    title: "Reliability",
    description: "With 24/7 security support in Melbourne, rapid response systems, and a dependable workforce, we provide consistent, trustworthy services to businesses large and small.",
    color: "#1e2247"
  },
  {
    id: 5,
    ...
    title: "Teamwork",
    description: "Metro Guards’ strength comes from collaboration. Guards, supervisors, and management work together to ensure seamless operations and constant support.",
    color: "#2d3748"
  },
  {
    id: 6,
    ...
    description: "We take full responsibility for our actions and decisions. Every member of our security team in Melbourne is committed to delivering reliable & transparent results.",
    color: "#4a5568"
  }
];
  ...
  return (
    <>
      <Layout
        ...
        mainTitle="Trusted Security Company <span style='color: #fdc51a; background: linear-gradient(135deg, #fdc51a 0%, #f39c12 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;'>Melbourne</span> | Integrity, Safety & Reliability"
        subtitle="In Security, Trust isn’t Claimed; It’s Earned"
                ...
                <div className="col-lg-10">
                  <div className="brand-label" style={{ marginBottom: '20px' }}>
                    <span style={{
                      ...
                      The Foundation of Trust and Protection
                    </span>
                  </div>
                  ...
                  <h2 style={{
                    ...
                    Leading Melbourne <span style={{ color: '#fdc51a' }}>Security Company</span>
                  </h2>
                  ...
                  <p style={{
                    ...
                    For over 16 years, Metro Guards has earned a reputation as a leading Melbourne security company. Our principles guide every decision, interaction, and service. These values aren’t just words. They define how we safeguard businesses, communities, and people across Melbourne.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="row justify-content-center text-center">
                <div className="col-lg-10">
                  <h2 style={{
                    ...
                    Professional Security, Exceptional Delivery
                  </h2>
                  ...
                  >
                    <p style={{
                      ...
                      At Metro Guards, our values translate into action. We are your trusted Melbourne security company, providing professional security services that businesses rely on every day.
                    </p>
                    ...
                    <div style={{
                      ...
                      <p style={{ marginBottom: '15px' }}>We offer a wide range of security guard services in Melbourne, including:</p>
                      <ul style={{ listStyleType: 'none', padding: 0 }}>
                        <li style={{ marginBottom: '10px', display: 'flex', alignItems: 'start' }}>
                          <span style={{ color: '#fdc51a', marginRight: '10px' }}>•</span>
                          Static security guards for corporate offices, retail stores, schools, hospitals, and industrial sites
                        </li>
                        <li style={{ marginBottom: '10px', display: 'flex', alignItems: 'start' }}>
                          <span style={{ color: '#fdc51a', marginRight: '10px' }}>•</span>
                          Mobile patrols Melbourne for alarm response services, construction sites, and rapid incident coverage
                        </li>
                        <li style={{ marginBottom: '10px', display: 'flex', alignItems: 'start' }}>
                          <span style={{ color: '#fdc51a', marginRight: '10px' }}>•</span>
                          Event security Melbourne for corporate functions, parties, and public gatherings
                        </li>
                        <li style={{ marginBottom: '10px', display: 'flex', alignItems: 'start' }}>
                          <span style={{ color: '#fdc51a', marginRight: '10px' }}>•</span>
                          Concierge and loss prevention security for retail and corporate clients
                        </li>
                        <li style={{ marginBottom: '10px', display: 'flex', alignItems: 'start' }}>
                          <span style={{ color: '#fdc51a', marginRight: '10px' }}>•</span>
                          Construction site security Melbourne, protecting equipment and staff with tailored solutions
                        </li>
                        <li style={{ marginBottom: '10px', display: 'flex', alignItems: 'start' }}>
                          <span style={{ color: '#fdc51a', marginRight: '10px' }}>•</span>
                          Industrial and warehouse security to safeguard assets, machinery, and stock
                        </li>
                      </ul>
                    </div>
                    ...
                    <p style={{
                      ...
                      Every service is designed to provide peace of mind. From hiring security guards for events to 24/7 mobile patrols in Melbourne, our team ensures your premises and assets are protected efficiently and professionally.
                    </p>
                  </div>
                </div>
              </div>
