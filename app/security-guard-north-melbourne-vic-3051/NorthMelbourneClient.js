...
export default function NorthMelbourneClient() {
    ...
    const services = [
        {
            ...
            description: "Comprehensive security solutions for North Melbourne homes and residential properties",
        ...
        },
        {
            ...
            details: "We offer tailored security solutions for commercial properties in North Melbourne, including access control, visitor management, and comprehensive monitoring to protect your business operations."
        },
        {
            title: "Healthcare Facility Security",
            icon: <Landmark size={24} />,
            iconSymbol: <Search size={24} />,
            description: "Specialized security for hospitals and healthcare facilities",
    ...
    const faqData = [
        {
            question: "Why choose Metro Guards for North Melbourne security?",
            answer: "Metro Guards has extensive experience serving North Melbourne with local knowledge of the area's unique security challenges. Our guards are familiar with local landmarks, traffic patterns, and community needs, ensuring faster response times and more effective protection."
        },
        {
            question: "What areas in North Melbourne do you cover?",
            answer: "We provide comprehensive security coverage throughout North Melbourne and surrounding suburbs including Carlton, Parkville, Brunswick, Fitzroy, Collingwood, and many more. Our local presence ensures quick response times across the entire area."
        },
        {
            question: "What types of security services do you offer in North Melbourne?",
            answer: "We offer a full range of security services including residential security, commercial building protection, healthcare facility security, event security, mobile patrols, and 24/7 monitoring services tailored to North Melbourne's specific needs."
        },
        {
            question: "How quickly can you deploy security guards in North Melbourne?",
            answer: "Our local presence in North Melbourne allows us to deploy security guards within hours of your request. For emergency situations, we can provide immediate response, and for planned security needs, we can arrange coverage within 24 hours."
        }
    ];
                    ...
                    <div className="container">
                        ...
                        <div className="row g-4">
                            {[
                                ...
                                { icon: <MapPin size={28} />, title: "Local Area Knowledge", description: "Familiar with North Melbourne's unique security challenges" },
                                ...
                                { icon: <Users size={28} />, title: "Experienced Team", description: "Years of experience serving North Melbourne community" },
