...
export default function SouthMelbournePage() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="South MELBOURNE"
                mainTitle="Security Guards & Mobile Patrols in South Melbourne Suburbs"
            ...
            >
                <div>
                    {/*===== About Metro Guards in South Melbourne Section =====*/}
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-header text-center mb-5">
                                        ...
                                        >
                                            About Metro Guards in <span style={{color: '#fdc51a'}}>South Melbourne</span>
                                        </h2>
                                        <p style={{
                                            color: '#6c757d',
                                            fontSize: '1.15rem',
                                            ...
                                            Metro Guards provides professional and fully insured security services to businesses and residents across all South Melbourne suburbs, including South Melbourne, St Kilda, Prahran, Dandenong, Frankston, and surrounding areas.
                                        </p>
                                    </div>

                                    {/* South Melbourne Info Cards */}
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            >
                                                ...
                                                <ul style={{
                                                    ...
                                                    {[
                                                        'Residential precincts (Albert Park, Elwood, Glen Iris, Bentleigh)',
                                                        'Retail and nightlife hubs (St Kilda, Prahran, Windsor, Southbank)',
                                                        'Commercial and industrial zones (Dandenong, Clayton, Mulgrave, Keysborough)',
                                                        'Event & entertainment venues (South Melbourne, Port Melbourne, Sandringham)'
                                                    ].map((item, index) => (
                                                        <li key={index} style={{
                                                            color: '#6c757d',
                                                            fontSize: '1.1rem',
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            >
                                                ...
                                                <p style={{
                                                    ...
                                                    These areas require flexible, trained, and locally experienced security teams. Metro Guards deploys officers from our Melbourne base, ensuring fast response, suburb-specific knowledge, and reliable protection for all sites.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    {/*===== South Melbourne Suburbs We Serve Section =====*/}
                    <div style={{
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-header text-center mb-5">
                                        ...
                                        >
                                            South Melbourne <span style={{color: '#fdc51a'}}>Suburbs We Serve</span>
                                        </h2>
                                        <p style={{
                                            color: '#6c757d',
                                            fontSize: '1.15rem',
                                            ...
                                            Our safety guards and patrol teams cover:
                                        </p>
                                    </div>
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-lg-10">
                                                ...
                                                <table style={{width: '100%', borderCollapse: 'collapse'}}>
                                                    ...
                                                    <tbody>
                                                        {[
                                                            ...
                                                            {suburb: 'Glen Iris', postcode: '3146'},
                                                            {suburb: 'Bentleigh', postcode: '3204'},
                                                            {suburb: 'Dandenong', postcode: '3175'},
                                                            {suburb: 'Springvale', postcode: '3171'},
                                                            {suburb: 'Clayton', postcode: '3168'},
                                                            {suburb: 'Mulgrave', postcode: '3170'},
                                                            {suburb: 'Keysborough', postcode: '3173'},
                                                            {suburb: 'Moorabbin', postcode: '3189'},
                                                            {suburb: 'Cheltenham', postcode: '3192'},
                                                            {suburb: 'Frankston', postcode: '3199'},
                                                            {suburb: 'Carrum Downs', postcode: '3201'},
                                                            {suburb: 'Sandringham', postcode: '3191'}
                                                        ].map((item, index) => (
                                                            <tr key={index} style={{
                                            ...
                                            <p style={{
                                                ...
                                                All surrounding South Melbourne suburbs are fully covered by our patrol and on-site guard teams.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-header text-center mb-5">
                                        ...
                                        >
                                            Most Demanding Security Services in <span style={{color: '#fdc51a'}}>South Melbourne</span>
                                        </h2>
                                        <p style={{
                                            color: '#6c757d',
                                            fontSize: '1.1rem',
                                            ...
                                            South Melbourne organisations face growing security challenges. Property & deception-related offences saw a significant rise, with property crimes increasing by 21.9% in 2024 across Victoria (ABC). This makes professional security services, including on-site guards, mobile patrols, and loss-prevention teams, essential for protecting businesses, retail precincts, residential areas, and construction sites.
                                        </p>
                                    </div>
                                    ...
                                    <div className="row g-4">
                                            ...
                                            >
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            ...
                                                            <p style={{color: '#fdc51a', fontSize: '0.9rem', marginBottom: '0', fontWeight: '600'}}>
                                                                Dandenong, Clayton, Mulgrave, Keysborough
                                                            </p>
                                                        </div>
                                                        <div style={{
                                                            fontSize: '3rem',
                                                ...
                                                <div style={{padding: '30px'}}>
                                                    <p style={{color: '#6c757d', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '20px'}}>
                                                        Suburbs like Dandenong, Clayton, Mulgrave, and Keysborough have active construction zones. Risks include:
                                                    </p>
                                                    <ul style={{
                                                        listStyle: 'none',
                                                        color: '#1e2247',
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <ul style={{
                                                            ...
                                                            <li style={{marginBottom: '0.5rem'}}>• Static 24/7 guards and overnight monitoring</li>
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            >
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            ...
                                                            <p style={{color: '#1e2247', fontSize: '0.9rem', marginBottom: '0', fontWeight: '600', opacity: 0.8}}>
                                                                St Kilda, Prahran, Windsor, South Melbourne
                                                            </p>
                                                        </div>
                                                        <div style={{
                                                            fontSize: '3rem',
                                                ...
                                                <div style={{padding: '30px'}}>
                                                    <p style={{color: '#6c757d', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '20px'}}>
                                                        Retail and nightlife areas (St Kilda, Prahran, Windsor, South Melbourne) require strong loss-prevention security due to:
                                                    </p>
                                                    <ul style={{
                                                        listStyle: 'none',
                                                        color: '#1e2247',
                                                        ...
                                                        <li style={{marginBottom: '0.6rem', display: 'flex', alignItems: 'flex-start'}}>
                                                            ...
                                                            <span>High foot traffic and theft</span>
                                                        </li>
                                                        <li style={{marginBottom: '0', display: 'flex', alignItems: 'flex-start'}}>
                                                            <span style={{color: '#1e2247', fontWeight: 'bold', fontSize: '1.1rem', marginRight: '0.75rem', lineHeight: '1.5', flexShrink: 0}}>✓</span>
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            >
                                                ...
                                                <div style={{padding: '30px'}}>
                                                    <p style={{color: '#6c757d', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '20px'}}>
                                                        Industrial and commercial zones (Dandenong, Clayton, Moorabbin) rely on:
                                                    </p>
                                                    <ul style={{
                                                        listStyle: 'none',
                                                        color: '#1e2247',
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            >
                                                ...
                                                <div style={{
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            ...
                                                            <p style={{color: '#1e2247', fontSize: '0.9rem', marginBottom: '0', fontWeight: '600', opacity: 0.8}}>
                                                                South Melbourne and surrounding suburbs
                                                            </p>
                                                        </div>
                                                        <div style={{
                                                            fontSize: '3rem',
                                                ...
                                                <div style={{padding: '30px'}}>
                                                    <p style={{color: '#6c757d', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '20px'}}>
                                                        Metro Guards protects warehouses and industrial estates across South Melbourne and surrounding suburbs with:
                                                    </p>
                                                    <div style={{
                                                        backgroundColor: 'rgba(30, 34, 71, 0.05)',
                                                        borderLeft: '4px solid #1e2247',
                                                        ...
                                                        <ul style={{
                                                            ...
                                                            <li style={{marginBottom: '0.5rem'}}>• Asset, vehicle, and equipment protection</li>
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            >
                                                ...
                                                <div style={{
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            ...
                                                            <p style={{color: '#fdc51a', fontSize: '0.9rem', marginBottom: '0', fontWeight: '600'}}>
                                                                Southbank, Prahran, South Melbourne
                                                            </p>
                                                        </div>
                                                        <div style={{
                                                            fontSize: '3rem',
                                                ...
                                                <div style={{padding: '30px'}}>
                                                    <p style={{color: '#6c757d', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '20px'}}>
                                                        Corporate offices, educational facilities, and medical institutions in Southbank, Prahran, and South Melbourne receive:
                                                    </p>
                                                    <div style={{
                                                        backgroundColor: 'rgba(253, 197, 26, 0.1)',
                                                        borderLeft: '4px solid #fdc51a',
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-header text-center mb-5">
                                    ...
                                    >
                                        Security Services Available Across <span style={{color: '#fdc51a'}}>All South Melbourne Suburbs</span>
                                    </h2>
                                </div>
                ...
                {/*===== South Melbourne Coverage Map Section =====*/}
                <div style={{
                    background: 'linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%)',
                    paddingTop: '80px',
                    paddingBottom: '80px',
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-header text-center mb-5">
                                    ...
                                    >
                                        Our Coverage Across <span style={{color: '#fdc51a'}}>South Melbourne</span>
                                    </h2>
                                    <p style={{
                                        color: '#6c757d',
                                        fontSize: '1.15rem',
                                        ...
                                        Metro Guards provides full coverage across all South Melbourne suburbs from our Melbourne operations base.
                                    </p>
                                </div>
                                ...
                                <div className="row g-4 align-items-center">
                                    ...
                                    <div className="col-lg-8">
                                        <div style={{
                                            ...
                                            <iframe
                                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d50452.89577885398!2d145.00870!3d-37.83710!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad668b3f0f0f0f0%3A0x5045675218ceed0!2sSouth%20Melbourne%20VIC%203205%2C%20Australia!5e0!3m2!1sen!2s!4v1234567890123!5m2!1sen!2s"
                                                width="100%"
                                                height="450"
                                                style={{border: 0}}
                                                allowFullScreen=""
                                    ...
                                    <div className="col-lg-4">
                                        <div className="d-flex flex-column gap-4">
                                            {[
                                                {icon: MapPin, title: '23+ Suburbs', desc: 'Complete South Melbourne coverage', color: 'blue'},
                ...
                {/*===== Meet Our South Melbourne Security Team Section =====*/}
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-header text-center mb-5">
                                    ...
                                    >
                                        Meet Our <span style={{color: '#fdc51a'}}>South Melbourne Security Team</span>
                                    </h2>
                                    <p style={{
                                        color: '#6c757d',
                                        fontSize: '1.15rem',
                                        ...
                                        Our South Melbourne deployment team includes:
                                    </p>
                                </div>
                                ...
                                <div className="row g-4 mb-5">
                                    {[
                                        {icon: Shield, title: 'Regional Security Supervisor – South Zone', desc: '16+ years in retail & industrial security', color: 'blue'},
                                        {icon: Target, title: 'Mobile Patrol Drivers (South Sector)', desc: 'GPS-monitored, trained in rapid response', color: 'yellow'},
                                        ...
                                        {icon: Eye, title: 'Retail Loss Prevention Officers', desc: 'Serving St Kilda, Prahran, Windsor, and South Melbourne shopping precincts', color: 'yellow'}
                                    ].map((team, index) => {
                ...
                {/*===== CTA Section - Ready to Secure Your Site in South Melbourne? =====*/}
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-10">
                                <div className="text-center mb-5">
                                    ...
                                    >
                                        Ready to Secure Your Site in <span style={{color: '#fdc51a'}}>South Melbourne?</span>
                                    </h2>
                                    <p style={{
                                        color: '#ffffff',
                                        fontSize: '1.3rem',
                                        ...
                                        Metro Guards are available 24/7 across all South Melbourne suburbs.
                                    </p>
                                    <p style={{
                                        color: '#fdc51a',
                                        fontSize: '1.2rem',
                ...
                <FAQSectionDynamic 
                    faqs={[
                        {
                            question: "Do you provide overnight construction site security in South Melbourne?",
                            answer: "Yes. Metro Guards offers overnight security officers, access control, equipment protection, and scheduled mobile patrols across South Melbourne suburbs, ensuring 24/7 safety for construction sites, high-risk zones, and active builds."
                        },
                        {
                            question: "How fast is your mobile patrol response in St Kilda or Dandenong?",
                            answer: "Our mobile patrols respond within minutes. GPS-tracked vehicles, local supervisors, and 24/7 monitoring ensure rapid deployment, providing fast, reliable security coverage for businesses, residential areas, and high-priority locations in St Kilda, Dandenong, and nearby suburbs."
                        },
                        {
                            question: "Can you provide retail guards for Prahran and Windsor?",
                            answer: "Yes. Metro Guards supplies trained retail security officers in Prahran, Windsor, and surrounding suburbs. Our guards focus on theft prevention, customer safety, and incident management, offering reliable on-site protection for shopping centres, boutiques, and high-traffic retail environments."
                        },
                        {
                            question: "Do you offer event security for festivals in South Melbourne?",
                            answer: "Yes. Event security officers and crowd controllers are available for festivals, venues, and private functions across South Melbourne. We ensure safe crowd management, incident prevention, and professional on-ground presence for seamless event security."
                        }
                    ]}
                />
            </Layout>
